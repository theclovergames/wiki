...
{% hint style="info" %}
Perdu ? `/help` en jeu donne l'aide contextuelle, et `/rules` rappelle le [Règlement](../le-serveur/reglement.md).
{% endhint %}
...
{% hint style="warning" %}
Le temps passé en **AFK ne rapporte aucun crédit**. Voir [Crédits](../le-serveur/credits-economie.md#gagner-des-credits).
{% endhint %}
...
Tous les détails sont sur [SkyPvP](../jouer/skypvp.md).
